...
<g id="Layer_2" data-name="Layer 2"><g id="Layer_2-2" data-name="Layer 2">
  <path class="cls-1" d="M14.11,111.5l5.77-15A62,62,0,1,1,40.21,122.8l-15.06,2.36L13.76,127A3.48,3.48,0,0,1,10,122.26Z"/>
  <path class="cls-2" d="M4.38,100.23l5.77-15a62.07,62.07,0,1,1,20.33,26.26l-15.07,2.37L4,115.68A3.48,3.48,0,0,1,.24,111Z"/>
  <path class="cls-3" d="M90.36,54.47H74.94V39.05a4.55,4.55,0,0,0-4.55-4.55h-5.8A4.56,4.56,0,0,0,60,39.05V54.47H44.62A4.56,4.56,0,0,0,40.06,59v5.8a4.56,4.56,0,0,0,4.56,4.55H60V84.79a4.56,4.56,0,0,0,4.56,4.55h5.8a4.55,4.55,0,0,0,4.55-4.55V69.37H90.36a4.55,4.55,0,0,0,4.55-4.55V59A4.55,4.55,0,0,0,90.36,54.47Z"/>
</g></g>
</svg>
</template>
<style scoped>
